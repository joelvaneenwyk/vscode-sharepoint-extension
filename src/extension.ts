...
export function activate(context: vscode.ExtensionContext): any {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.checkOutFile', (selectedResource?: Uri) => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.compareFileWithServer', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.configureWorkspace', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.copyRelativeUrl', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.copyAbsoluteUrl', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.deleteFile', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.discardCheckOut', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    // Delete the current file.
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.getServerVersion', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.populateWorkspace', () => {
    ...
    // Uses the active document to determine the publishing workspace.
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.publishWorkspace', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.publishMajor', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    // Publish the current file to the server.
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.publishMinor', (selectedResource?: Uri) => {
            selectedResource = selectedResource || WorkspaceHelper.getActiveFile();
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.reloadConfiguration', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.resetCredentials', () => {
    ...
    // Download the contents of a SharePoint folder (and subfolders) to your local workspace.
    context.subscriptions.push(
        vscode.commands.registerCommand('spgo.retrieveFolder', () => {
            ...
            vscode.window.spgo.initialize(textDocument.uri).then((config: IConfig) => {
                if (config) {
                    ...
                    if (
                        ...
                        Constants.PUBLISHING_NONE != config.publishingScope
                    ) {
                        if (
                            Constants.PUBLISHING_MAJOR == config.publishingScope ||
                            Constants.PUBLISHING_MINOR == config.publishingScope
                        ) {
                            const command: ICommand = new PublishFileCommand();
    ...
    context.subscriptions.push(
        vscode.workspace.onDidOpenTextDocument((textDocument: vscode.TextDocument) => {
            const selectedResource: Uri =
                textDocument.uri.scheme !== 'output' ? textDocument.uri : WorkspaceHelper.getActiveFile();
